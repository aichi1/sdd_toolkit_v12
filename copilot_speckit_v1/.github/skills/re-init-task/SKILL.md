---
name: re-init-task
description: 現在のイテレーションが完了した後、新しいイテレーションを開始する。差分だけをヒアリングして docs/ を追記更新し、連番を継続して新しいフェーズの skills/ を作成する。「次のイテレーションを始めたい」「追加要件が出た」ときに使う。
argument-hint: 追加・変更したい内容（省略可）
...
- `AGENTS.md` — Deliverables セクションをイテレーション区分付きに更新
...
- [ ] AGENTS.md の Deliverables がイテレーション区分付きフォーマットに更新されている
...
| AGENTS.md の Deliverables セクションが見つからない | セクションを新規追加 |
...
- AGENTS.md の Deliverables セクションを全置換してしまう → 既存内容を Iteration 1 として維持
