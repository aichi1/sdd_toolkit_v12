---
name: eval
description: SDD spec-kit 自身を固定3シナリオ（T1_research / T2_implement / T3_proposal）で自己評価する。eval/rubric.json の7軸で採点し、eval/runs/ に score.json を保存、aggregate.py で履歴化とグラフ生成まで行う。「toolkit を評価したい」「スコアを測りたい」ときに使う。
argument-hint: iteration_id（例: v1.0）[--review-interval N]
