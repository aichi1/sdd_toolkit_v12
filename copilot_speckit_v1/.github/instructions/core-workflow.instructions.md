---
description: SDD のコマンド順序・各コマンドの入出力・フェーズ依存関係・エラーハンドリング。すべての SDD 作業の骨格。
applyTo: "**"
---
...
## /init-task
- Creates: docs/ (What), skills/ (How), AGENTS.md, metadata.json
...
- Flow:
  ...
  8. Update AGENTS.md Deliverables section (add iteration subsection)
...
- See: `.github/skills/add-feature/SKILL.md`（手順の実体）, `.github/prompts/add-feature.prompt.md`（VS Code 用ラッパ）
