...
- GitHub Copilotが「今日は○○から始めますか？」と提案
- セッション途中でも目標を動的調整
```
...
- [ ] AGENTS.md → "Next Session Starter"を読む
- [ ] 前回の終了コミットIDを確認
...
**実行内容:**
1. AGENTS.mdの"Next Session Starter"を読み込み
...
grep -A 20 "Next Session Starter" AGENTS.md
```

### Phase 2: Slash Command実装
- repo/.github/prompts/ にコマンド追加
- AGENTS.mdの構造化（YAML frontmatter）
- テンプレート変数の活用
